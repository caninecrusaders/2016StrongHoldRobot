 ...
 *
 */
public class TurnToCounterClockwise extends Command {
    ...
    protected void initialize() {
    	...
    	if(ahrs!=null){
	    	...
	    	Robot.driveSystem.getPIDController().setOutputRange(-1.0, 0.0);//Sets the the MIN and MAX values to write to output
    ...
    protected boolean isFinished() {
        ...
        return Robot.driveSystem.onTarget();
    }
