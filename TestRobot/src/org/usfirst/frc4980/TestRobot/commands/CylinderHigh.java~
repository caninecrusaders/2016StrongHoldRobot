 ...
 *
 */
public class CylinderHigh extends Command {
    ...
    protected void execute() {
    	SmartDashboard.putString("Climber Position", "Go High");
    ...
    protected void end() {
    	Robot.climber.climberPosition = Robot.climber.kHigh;
    	//Robot.climber.ClimberStop();
    	SmartDashboard.putString("Climber Position", "At High Position");
    }
